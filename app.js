(() => {
  ...
  function openBot() {
    const username = botUsername() || "mental_traderbot";
    ...
    try {
      if (tg?.openTelegramLink) {
        ...
        // Telegram Desktop can keep the Mini App window above the bot chat.
        // Close the Mini App shortly after opening the Telegram link so the
        // user immediately sees the MENTAL TRADER bot.
        window.setTimeout(() => {
